  ...
  return (
    <div
      ...
      className={`
        ...
        ${isHome
          ? 'bg-white/90 backdrop-blur-md rounded-2xl p-6 border border-white/40 mb-4 dark:bg-slate-800/90 dark:border-slate-700 shadow-sm'
          : isSelected
        ...
        ${isHome && !isOverlay ? 'hover:shadow-xl hover:-translate-y-0.5 active:scale-[0.98] active:shadow-none' : ''}
        ${isOverlay
